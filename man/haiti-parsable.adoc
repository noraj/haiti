...
haiti-parsable - Display hash types matching that have a Hashcat or John the Ripper reference in an easily parsable format
...
Copyright © 2020-2026 Alexandre ZANNI (independent)
